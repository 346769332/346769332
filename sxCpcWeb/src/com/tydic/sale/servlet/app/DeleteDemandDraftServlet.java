...
@WebServlet("/app/deleteDemandDraft.do")
public class DeleteDemandDraftServlet extends AbstractServlet {
	 ...
	 */
	public DeleteDemandDraftServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		//查询
		Map<Object,Object> resultMap = super.crmService.removeDemandDraftLst(reqParamMap);
