...
@WebServlet("/app/flowExChange.do")
public class FlowExChangeServlet extends AbstractServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(FlowExChangeServlet.class);
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FlowExChangeServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		String opt 			= String.valueOf(reqparamMap.get("opt"));
		String demand_theme = String.valueOf(reqparamMap.get("demand_theme"));
		String rating01	 	= String.valueOf(reqparamMap.get("eval_time"));
		String rating02	 	= String.valueOf(reqparamMap.get("over_eval"));
		String rating03	 	= String.valueOf(reqparamMap.get("eval_atti"));
		String evalOpinion 	= String.valueOf(reqparamMap.get("over_opinion"));
		String demand_id 	= String.valueOf(reqparamMap.get("demand_id"));
		String curr_record_id = String.valueOf(reqparamMap.get("curr_record_id"));
		String curr_node_id = String.valueOf(reqparamMap.get("curr_node_id"));
		String curr_node_name = String.valueOf(reqparamMap.get("curr_node_name"));
		String opt_id 		= String.valueOf(reqparamMap.get("opt_id"));
		String opt_name 	= String.valueOf(reqparamMap.get("opt_name"));
		String mob_tel 		= String.valueOf(reqparamMap.get("mob_tel"));
		
		String pase_node_id   = String.valueOf(reqparamMap.get("pase_node_id"));
		String pase_node_name = String.valueOf(reqparamMap.get("pase_node_name"));
		String pase_opt_id 	 = String.valueOf(reqparamMap.get("pase_opt_id"));
		String pase_opt_name = String.valueOf(reqparamMap.get("pase_opt_name"));
		String pase_opt_org = String.valueOf(reqparamMap.get("pase_opt_org"));
		String pase_mob_tel  = String.valueOf(reqparamMap.get("pase_mob_tel"));
		String pase_staff_id=String.valueOf(reqparamMap.get("pase_staff_id"));
		String pase_org_id=String.valueOf(reqparamMap.get("pase_org_id"));
		String isProvince=String.valueOf(reqparamMap.get("isProvince"));
		System.out.println("pase_org_id========打回人部门id============"+pase_org_id);
		...
		//保存当前环节处理人信息
		cpcFlowRecord.put("staff_id", sysUser.getStaffId());
		cpcFlowRecord.put("staff_name", sysUser.getStaffName());
		cpcFlowRecord.put("department_id", sysUser.getOrgId());
		cpcFlowRecord.put("department_name", sysUser.getOrgName());
		cpcFlowRecord.put("mob_tel", sysUser.getMobTel());
		//打分
		if("1".equals(opt)){
			demand.put("eval_time", rating01);
			demand.put("over_eval", rating02);
			demand.put("eval_atti", rating03);
			...
			cpcFlowRecord.put("funTypeId", "100098");
			cpcFlowRecord.put("opt_id"		, opt_id);
			cpcFlowRecord.put("opt_name"	, opt_name);
		}
		...
		if("-1".equals(opt)
			...
			if("true".equals(isProvince)&&"290".equals(sysUser.getRegionCode())){
				System.out.println("pase_org_id========开始发送短信============"+pase_org_id);
				Map<Object,Object> deptStaffInfo = new HashMap<Object,Object>();
