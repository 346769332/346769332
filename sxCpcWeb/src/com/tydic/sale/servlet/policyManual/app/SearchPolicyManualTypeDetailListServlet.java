...
@WebServlet("/app/searchPolicyManualTypeDetailList.do")
public class SearchPolicyManualTypeDetailListServlet extends AbstractServlet {
	private final static Logger logger = LoggerFactory.getLogger(SearchPolicyManualTypeDetailListServlet.class);
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SearchPolicyManualTypeDetailListServlet() {
		super(); 
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		reqParamMap.put("SERVER_NAME", "searchPolicyManualTypeDetailList");
