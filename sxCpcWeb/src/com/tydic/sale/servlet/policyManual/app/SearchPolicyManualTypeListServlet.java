...
@WebServlet("/app/searchPolicyManualTypeList.do")
public class SearchPolicyManualTypeListServlet extends AbstractServlet {
	private final static Logger logger = LoggerFactory.getLogger(SearchPolicyManualTypeListServlet.class);
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SearchPolicyManualTypeListServlet() {
		super(); 
	}
...
//		reqParamMap.put("pagenum", (Integer.parseInt(pageNum)+1));
		...
		//查询
		reqParamMap.put("SERVER_NAME", "searchPolicyManualTypeList");
