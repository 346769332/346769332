 ...
 */
@WebServlet("/shortProcess/addWorkflowback.do")
public class AddWorkflowBackServlet extends AbstractServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddWorkflowBackServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		//模板属性
		String templatepro=request.getParameter("attrDesc");
		//获取第二部 处理时限
		//处理时限
