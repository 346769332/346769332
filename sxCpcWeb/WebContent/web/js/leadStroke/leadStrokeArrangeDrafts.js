var LeadStrokeArrangeDrafts = new Function();
LeadStrokeArrangeDrafts.prototype = {
	selecter : "#leadStrokeArrangeSendPage",
	dateInfo : "",
	headlineInfo : "",
	ascriptionLaedId : "",
	ascriptionLaedName : "",
	...
	bindMetod : function(parentThis) {
		...
		// 修改
		var updateInfoObj = parentThis.selecter.findById("a", "updateInfo")[0];
		updateInfoObj.unbind("click").bind("click", function() {
			parentThis.thisWeekModelUpdate(parentThis);
		});
		// 导出
		var dataUploadObj = parentThis.selecter.findById("span", "dataUpload")[0];
		dataUploadObj.unbind("click").bind("click", function() {
			parentThis.uploadLeadStrokeInfo(parentThis);
		});
	},	
				 ...
				 $.jump.ajax(URL_QUERY_COMMON_METHOD.encodeUrl(), function(json) {
						if(json.code == "0" ){	
							if(json.data.length>0){
								...
								$.each(dataLst,function(j,obj){	
									debugger;
									$("#headlineInfo").html(obj.HEADLINEINFO);
									if(obj.PERIODTIME=='上午'){
										html+="<tr><td rowspan='2' style='text-align: center;' >";
										html+="<textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIME+"'>"+obj.STROKETIME+"</textarea></td>";
										html+="<td style='text-align: center;display: none;'><textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIMESTART+"'>"+obj.STROKETIMESTART+"</textarea></td>";
										html+="<td style='text-align: center;' ><textarea style='text-align: center;width: 87%;border-style: none;overflow: hidden;'readonly value='"+obj.PERIODTIME+"'>"+obj.PERIODTIME+"</textarea></td>";
										html+="<td><textarea  style='width: 97%;border-style: none;overflow: hidden;' value='"+obj.STROKEINFO+"'readonly>"+obj.STROKEINFO+"</textarea></td>";
										html+="<td><textarea  style='width: 97%;border-style: none;overflow: hidden;' value='"+obj.REMARKINFO+"'readonly>"+obj.REMARKINFO+"</textarea></td></tr>";
									}else{
										html+="<tr><td style='text-align: center;display: none;'>";
										html+="<textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIME+"'>"+obj.STROKETIME+"</textarea></td>";
	...
	thisWeekModelUpdate: function(parentThis) {
	      var cells = parentThis.selecter.findById("tbody","leadStrokeAddInfo")[0];
	      var weeks;
	      var clen = 7;
	      var currentFirstDate;
							...
							if(json.data.length>0){
								...
								$.each(dataLst,function(j,obj){	
									...
									if(obj.PERIODTIME=='上午'){
										...
										html+="<td style='text-align: center;display: none;'><textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIMESTART+"'>"+obj.STROKETIMESTART+"</textarea></td>";
										html+="<td style='text-align: center;' ><textarea style='text-align: center;width: 87%;border-style: none;overflow: hidden;'readonly value='"+obj.PERIODTIME+"'>"+obj.PERIODTIME+"</textarea></td>";
										html+="<td><textarea  style='width: 97%;border-style: none;overflow: hidden;' value='"+obj.STROKEINFO+"'>"+obj.STROKEINFO+"</textarea></td>";
										html+="<td><textarea  style='width: 97%;border-style: none;overflow: hidden;' value='"+obj.REMARKINFO+"'>"+obj.REMARKINFO+"</textarea></td></tr>";
									}else{
										html+="<tr><td style='text-align: center;display: none;'>";
									    html+="<textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIME+"'>"+obj.STROKETIME+"</textarea></td>";
									    html+="<td style='text-align: center;display: none;'><textarea style='text-align: center;width: 95%;border-style: none;overflow: hidden;'readonly value='"+obj.STROKETIMESTART+"'>"+obj.STROKETIMESTART+"</textarea></td>";
...
//	        }; 
	...
	sendSaveInfo : function(parentThis) {
		...
		var param={
				...
				"startDate"         		:  parentThis.startDate,//开始时间
				...
				"saveType"          	    :  "send",//parentThis.headlineInfo,//标题
				"methodType"      			:  "submitLeadStrokeInfo" 
		};
	...
	submitSaveInfo : function(parentThis) {
		...
		var param={
				...
				"ascriptionLaedPosition"    :  parentThis.ascriptionLaedPosition,//领导职务
				"headlineInfo"          	:  parentThis.headlineInfo,//标题
				"saveType"          	    :  "submit",//parentThis.headlineInfo,//标题
				"methodType"      			:  "submitLeadStrokeInfo" 
		};
	...
	uploadLeadStrokeInfo : function(parentThis){
			var param={
	  				"dateInfo"				:	parentThis.dateInfo,
	  				"headlineInfo"			:	parentThis.headlineInfo,
	  				"startDate"				:	parentThis.startDate,
	  				"endDate"				:	parentThis.endDate
			};
			window.location.href=URL_DOWN_PDF_DRAFTSLEADSTORKE+"?"+encodeURI($.param(param));
	},
};
