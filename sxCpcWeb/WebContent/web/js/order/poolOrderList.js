var PoolOrderList = new Function();

PoolOrderList.prototype = {
	selecter : "#poolOrderLstPage",
	pageSize : 10,
	ceoType : null,
	//初始化执行
	init : function() {
	...
	createLstHtml : function(parentThis,data,orderLstBodyObj){
		...
		$("#poolOrderLstPage").find("a[name=chuli]").unbind("click").bind("click",function(){
		...
		$("#poolOrderLstPage").find("td[name=demandInfo]").unbind("click").bind("click",function(){
